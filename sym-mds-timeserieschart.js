(function (PIVS) {
    ...
    var defintion = {
        typeName: 'timeserieschart-chartjs',
        datasourceBehavior: PIVS.Extensibility.Enums.DatasourceBehaviors.Multiple,
        visObjectType: symbolVis,
        getDefaultConfig: function () {
            return {
                DataShape: 'TimeSeries',
                DataQueryMode: PIVS.Extensibility.Enums.DataQueryMode.ModePlotValues,
                Interval: 400,
                Height: 200,
                Width: 400
            };
    ...
    PIVS.symbolCatalog.register(defintion);
